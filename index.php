...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="img/AB.png" width="100%" height="300">
              </div>
            </div>
            <hr>
            <br>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br><br>
                    <a href="alluser.php"><button style="background-color : #2785C4;">View All User</button></a>
                  </div>
                  <div class="col-md act">
      ...
      <footer class="text-center mt-5 py-2" style="background-color:#3fdfe2;">
        <p style="color:black;">&copy 2021. Made by <b>Abhishek Bhambre</b> <br></p>
      </footer>
